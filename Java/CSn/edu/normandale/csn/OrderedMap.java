 ...
 * <br><br>
 * A map is a collection of key/value pairs that allows
 ...
 * @author rdwells
 *
 * @param <Key>	The type used for the keys in the map.
 * @param <Value> The type used for the values in the map.
 */
interface OrderedMap<Key extends Comparable<Key>, Value> extends Map<Key, Value> {
	/**
	 * Returns the minimum key in the map, or <tt>null</tt> if the map is empty.
	 * 
	 * @return		The minimum value of any key in the map.
	 */
	Key min();
	
	/**
	 * Returns the maximum key in the map, or <tt>null</tt> if the map is empty.
	 * 
	 * @return		The maximum value of any key in the map.
	 */
	Key max();
	 ...
	 * given key. If all the keys in the map are less than
